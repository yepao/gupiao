...
public class StockDao extends BaseDao {
	...
	public List<StockFlow> selectStockFlowByUid(StockFlow stockflow) throws Exception { 
		List<StockFlow> list=null;
		try{
			list=getSqlMapClientTemplate().queryForList("selectStockFlowByUid",stockflow);
		}catch(Exception e)
		{
			e.printStackTrace();
			throw e;
	...
	public List<StockProfit> selectStockProfitByCtype(StockProfit stockprofit) throws Exception { 
		List<StockProfit> list=null;
		try{
			list=getSqlMapClientTemplate().queryForList("selectStockProfitByCtype",stockprofit);
		}catch(Exception e)
		{
			e.printStackTrace();
			throw e;
	...
	public List<StockUser> selectStockIds() throws Exception { 
		List<StockUser> list=null;
		try{
			list=getSqlMapClientTemplate().queryForList("selectStockIds");
		}catch(Exception e)
		{
			e.printStackTrace();
			throw e;
	...
	public List<StockShow> selectAllStockShow() throws Exception {
		...
		try{
			list=getSqlMapClientTemplate().queryForList("selectAllStockShow");
		}catch(Exception e)
		{
			e.printStackTrace();
			throw e;
	...
	public List<StockShow> selectStockShowByUid(int uid) throws Exception {
		List<StockShow> list=null;
		try{
			list=getSqlMapClientTemplate().queryForList("selectStockShowByUid",uid);
		}catch(Exception e)
		{
			e.printStackTrace();
			throw e;
	...
	public List<StockShow> selectShowByUid(int uid) throws Exception {
		List<StockShow> list=null;
		try{
			list=getSqlMapClientTemplate().queryForList("selectShowByUid",uid);
		}catch(Exception e)
		{
			e.printStackTrace();
			throw e;
	...
	public int insertStockShow(StockShow stockshow) throws Exception {  
		int key=0;  
		try { 
			key=(Integer)getSqlMapClientTemplate().insert("insertStockShow", stockshow);
		} catch (Exception e) {  
			e.printStackTrace(); 
			throw e;  
		}  
	...
	public int updateStockShow(StockShow stockshow) throws Exception {  
		int key=0;  
		try { 
			key=(Integer)getSqlMapClientTemplate().update("updateStockShow", stockshow);
		} catch (Exception e) {  
			e.printStackTrace(); 
			throw e;  
		}  
