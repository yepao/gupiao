...
public class CashController {
	...
	@Autowired
	private CashService dcashService;
	...
	public @ResponseBody String cashTran2() throws Exception {
		try
		{
			...
			int ident=dcashService.addCash(ent);
			Gson gson=new Gson();
	...
	public @ResponseBody String cashflow() throws Exception {
		try
		{
			...
			int ident=dcashService.updateCash(ent,-13.7);
			Gson gson=new Gson();
			return ent.getCash()+"gg"+ident+"hh";
		}
		catch(Exception e)
	...
	public @ResponseBody String delcashflow() throws Exception {
		try
		{
			...
			int ident=dcashService.deleteCashFlowById(17);
			Gson gson=new Gson();
			return ent.getCash()+"gg"+ident+"hh";
		}
		catch(Exception e)
